...
// Parametros de entrada: estrutura com os pais (parents), estrutura com parametros (d), estrutura que guardara os descendentes (offspring)
...
// Preenche o vector descendentes com o resultado da operaao de recombinaao com dois pontos de corte
// Parametros de entrada: estrutura com os pais (parents), estrutura com parametros (d), estrutura que guardara os descendentes (offspring)
